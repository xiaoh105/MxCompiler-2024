/*
 * Mx Compiler
 * File Name: class_collector.h
 * Identification: ./src/include/frontend/class_collector.h
...
/**
 * ClassCollector scans the parser tree and set up the type information for the global scope
 */
class ClassCollector : public ASTVisitor {
 public:
  ClassCollector(GlobalScope &global_scope);
