...
declare dso_local noundef i32 @putchar(i32 noundef) local_unnamed_addr #2

; Function Attrs: nounwind
define dso_local void @printInt(i32 noundef %0) local_unnamed_addr #0 {
  %2 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @.str.1, i32 noundef %0) #11
  ret void
}
...
define dso_local i32 @getInt() local_unnamed_addr #2 {
  ...
  %2 = call i32 (ptr, ...) @scanf(ptr noundef nonnull @.str.1, ptr noundef nonnull %1) #12
...
define dso_local noalias noundef ptr @toString(i32 noundef %0) local_unnamed_addr #2 {
  ...
  %3 = tail call i32 (ptr, ptr, ...) @sprintf(ptr noundef nonnull dereferenceable(1) %2, ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %0) #12
  ret ptr %2
}
...
define dso_local i32 @ptr.length(ptr nocapture noundef readonly %0) local_unnamed_addr #5 {
...
; Function Attrs: nounwind
define dso_local noundef ptr @ptr.substring(ptr noundef %0, i32 noundef %1, i32 noundef %2) local_unnamed_addr #0 {
  %4 = sub nsw i32 %2, %1
  %5 = add nsw i32 %4, 1
...
; Function Attrs: nofree nounwind
define dso_local i32 @ptr.parseInt(ptr nocapture noundef readonly %0) local_unnamed_addr #2 {
  %2 = alloca i32, align 4
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %2) #14
  %3 = call i32 (ptr, ptr, ...) @sscanf(ptr noundef %0, ptr noundef nonnull @.str.1, ptr noundef nonnull %2) #12
...
; Function Attrs: nounwind
define dso_local void @builtin.printBool(i8 noundef zeroext %0) local_unnamed_addr #0 {
  %2 = icmp eq i8 %0, 0
  %3 = select i1 %2, ptr @.str.4, ptr @.str.3
  %4 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull %3) #11
  ret void
}
