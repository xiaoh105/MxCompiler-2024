...
; Function Attrs: mustprogress nofree nounwind willreturn memory(argmem: read)
define dso_local i32 @ptr_length(ptr nocapture noundef readonly %0) local_unnamed_addr #2 {
  %2 = tail call i32 @strlen(ptr noundef nonnull dereferenceable(1) %0) #11
  ret i32 %2
}

; Function Attrs: nounwind
define dso_local noundef ptr @ptr_substring(ptr noundef %0, i32 noundef %1, i32 noundef %2) local_unnamed_addr #3 {
  %4 = sub nsw i32 %2, %1
  %5 = add nsw i32 %4, 1
...
; Function Attrs: nofree nounwind
define dso_local i32 @ptr_parseInt(ptr nocapture noundef readonly %0) local_unnamed_addr #0 {
...
define dso_local i32 @ptr_ord(ptr nocapture noundef readonly %0, i32 noundef %1) local_unnamed_addr #6 {
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: read)
define dso_local i32 @builtin_getSize(ptr nocapture noundef readonly %0) local_unnamed_addr #6 {
...
; Function Attrs: nounwind
define dso_local void @builtin_printBool(i8 noundef zeroext %0) local_unnamed_addr #3 {
  %2 = icmp eq i8 %0, 0
...
define dso_local noalias nonnull ptr @builtin_allocArray(i32 noundef %0) local_unnamed_addr #7 {
  %2 = add i32 %0, 1
...
define dso_local noundef ptr @builtin_stringConcatenate(ptr nocapture noundef readonly %0, ptr nocapture noundef readonly %1) local_unnamed_addr #9 {
